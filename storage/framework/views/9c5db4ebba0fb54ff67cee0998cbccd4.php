    ...
    <div class="container-fluid home">
      ...
      <header class="d-flex justify-content-between align-items-center p-3 border-bottom">
        <div class="d-flex align-items-center">
          <img class="home-icon me-2" alt="Home Icon" src="<?php echo e(asset('photo/home-breadcrumbs.png')); ?>">
      ...
      <div class="menu-main">
          ...
          <div class="menu-section">
              ...
              <a href="<?php echo e(url('/contact')); ?>" class="menu-button">
                  <div class="menu-item">Contact us</div>
              </a>
              <a href="<?php echo e(url('/about')); ?>" class="menu-button">
      ...
      <div class="content-area">
        <div class="uprm-portico-banner position-relative">
          <img src="<?php echo e(asset('photos/UPRM-portico-banner.png')); ?>" class="uprm-portico-banner-1-icon img-fluid" alt="UPRM Banner">
          <div class="uprm-portico-banner-text">CHEMTRACK</div>
        </div>

        <div class="hero-container">
          <div class="hero-left">
            <img class="logochemtrack-transparent-1-icon img-fluid mb-3" alt="ChemTrack Logo" src="<?php echo e(asset('photo/Logo ChemTrack.jpg')); ?>">
          ...
          <div class="hero-right">
            <img class="ossoa-image img-fluid" src="<?php echo e(asset('photo/ossoa logo.png')); ?>" alt="OSSOA Logo">
          </div>
        </div>
      </div>
...
<?php /**PATH C:\Users\orlan_t0jk0pf\Herd\practice\resources\views/homeLogin.blade.php ENDPATH**/ ?>